...
# Reusable fucntion for loading data into R
...
# Creating arguments for the data load function
...
# loading package "Amelia" for missmap 
require(Amelia)
...
# barplot for distribution of different variables
...
# loading "vcd" package for mosaic plot
require(vcd)

# mosaic plot to see distribution of variables across 
...
# Correlogram for correlation between numerical variables
require(corrgram)
...
# loading plyr package for revalue function
require(plyr)
corrgram.data$Embarked <- revalue(corrgram.data$Embarked, 
                                  c("C" = 1, "Q" = 2, "S" = 3))

## generate correlogram for numerical variables
...
# Get titles out of the name variable
...
# Summary of the Age varibles across Titles
options(digits = 2)
require(Hmisc)
